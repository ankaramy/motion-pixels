...
def main(
    ...
    image_traj_csv = "outputs/trajectories_image_space.csv"
    world_traj_csv = "outputs/trajectories_world.csv"
    ...
    if calib_json:
        ...
        calibrated = run_script("calibrate_homography.py", [
            ...
            "--out_plot", "outputs/trajectories_world_plot.png",
        ], check=False)
